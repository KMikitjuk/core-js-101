...
function angleBetweenClockHands(date) {
  ...
  let time = dateInMS % (1000 * 60 * 60 * 24);
  time /= 1000 * 60;
  const mins = time % 60;
  ...
  const hoursAngle = hours * (360 / 12) + mins * (30 / 60);
  const minsAngle = (360 / 60) * mins;

  let resAngle = Math.abs(minsAngle - hoursAngle);
  if (resAngle > 180) {
